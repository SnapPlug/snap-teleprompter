...
| 카테고리      | 기능                                                                                |
| --------------- | ------------------------------------------------------------------------------------- |
| **기본**      | 대본 직접 입력 ·`.txt` / `.md` 파일 불러오기                                       |
| **재생 제어** | 재생 / 일시정지 / 정지 · 속도 조절 (20~ 280 WPM) · 글자 크기 조절 (10 ~ 22pt)    |
| **조작**      | 노치 탭으로 일시정지/재개 · 스크롤로 위치 이동 · 키보드 단축키`Space` / `<` / `>` |
| **편의**      | 문장 단위 줄바꿈 · 예상 발표 시간 · 발표 타이머 (MM:SS)                           |
| **화면**      | 배경색 선택 (검정/흰색) · 노치 크기 조절 · 화면 공유 숨김 (Zoom/Teams)            |
